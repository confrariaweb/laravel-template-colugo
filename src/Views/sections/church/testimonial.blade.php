        ...
        <div class="testimonial-slides">
            ...
            <div class="client-thumbnails">
                <div>
                    <div class="item">
                        <div class="img-fill">
                            <img src="{{ asset('vendor/confrariaweb/template-colugo/img/client/1.jpg') }}"
                                 alt="client">
                        </div>
                    ...
                    <div class="item">
                        <div class="img-fill">
                            <img src="{{ asset('vendor/confrariaweb/template-colugo/img/client/2.jpg') }}"
                                 alt="client">
                        </div>
                    ...
                    <div class="item">
                        <div class="img-fill">
                            <img src="{{ asset('vendor/confrariaweb/template-colugo/img/client/3.jpg') }}"
                                 alt="client">
                        </div>
                    ...
                    <div class="item">
                        <div class="img-fill">
                            <img src="{{ asset('vendor/confrariaweb/template-colugo/img/client/4.jpg') }}"
                                 alt="client">
                        </div>
                    ...
                    <div class="item">
                        <div class="img-fill">
                            <img src="{{ asset('vendor/confrariaweb/template-colugo/img/client/5.jpg') }}"
                                 alt="client">
                        </div>
